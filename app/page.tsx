              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                ...
                >
                  <div className="flex flex-col items-center text-center">
                    ...
                    <div className="text-3xl font-bold text-[#3E3C6B] mb-2">10,053</div>
            ...
            <TabsContent value="updates" className="space-y-4">
              <div className="grid md:grid-cols-3 gap-4">
                <article className="bg-white p-5 rounded-2xl shadow-sm">
                  <img src="/assets/pocket-coach.jpg" alt="PocketCoach success" className="w-36 h-36 object-contain rounded-md mb-3 bg-white" />
                ...
                <article className="bg-white p-5 rounded-2xl shadow-sm">
                  <img src="/assets/epicure-robotics.jpg" alt="Epicure Robotics" className="w-36 h-36 object-contain rounded-md mb-3 bg-white" />
                ...
                <article className="bg-white p-5 rounded-2xl shadow-sm">
                  <img src="/assets/aalap-ai.jpg" alt="Aalap AI" className="w-36 h-36 object-contain rounded-md mb-3 bg-white" />
                ...
                <article className="bg-white p-5 rounded-2xl shadow-sm">
                  <img src="/assets/authify.jpg" alt="Authify" className="w-36 h-36 object-contain rounded-md mb-3 bg-white" />
                ...
                <article className="bg-white p-5 rounded-2xl shadow-sm">
                  <img src="/assets/smartchakra.jpg" alt="SmartChakra" className="w-36 h-36 object-contain rounded-md mb-3 bg-white" />
                ...
                <article className="bg-white p-5 rounded-2xl shadow-sm">
                  <img src="/assets/zeru.jpg" alt="Zeru Finance" className="w-36 h-36 object-contain rounded-md mb-3 bg-white" />
