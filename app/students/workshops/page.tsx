    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[85vh] flex items-center justify-center overflow-hidden bg-[#00377B]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center text-white">
          ...
          >
            Hands-on learning experiences designed to build practical skills in machine learning, AI, and emerging technologies.
          </motion.p>
        ...
        <div className="max-w-7xl mx-auto">
          <Tabs defaultValue="paml" className="w-full">
            ...
            <TabsList className="bg-white mb-8 p-1 space-x-1">
              ...
              {/* Add more tabs here like Summer Workshop 2024 */}
            </TabsList>

            {/* PAML Tab Content */}
            <TabsContent value="paml">
              {/* PAML Header */}
              <motion.div
                  ...
                  <div className="md:col-span-2">
                    <Tabs defaultValue="overview">
                      <TabsList className="flex flex-wrap gap-2 mb-4 w-full">
                        <TabsTrigger
                          value="overview"
                          style={{ ['--tab-color']: pamlTabColors.overview } as React.CSSProperties}
                        ...
                        <TabsTrigger
                          value="what"
                          style={{ ['--tab-color']: pamlTabColors.what } as React.CSSProperties}
                          className="px-3 py-2 text-xs sm:text-sm font-medium text-black border-b-2 border-transparent data-[state=active]:text-[var(--tab-color)] data-[state=active]:border-[var(--tab-color)] whitespace-nowrap"
                        >
                          What You Will Do
                        </TabsTrigger>
                        ...
                        <TabsTrigger
                          value="sessions"
                          style={{ ['--tab-color']: pamlTabColors.sessions } as React.CSSProperties}
                          className="px-3 py-2 text-xs sm:text-sm font-medium text-black border-b-2 border-transparent data-[state=active]:text-[var(--tab-color)] data-[state=active]:border-[var(--tab-color)] whitespace-nowrap"
                        >
                          Session Plans
                        </TabsTrigger>
                        ...
                        <TabsTrigger
                          value="logistics"
                          style={{ ['--tab-color']: pamlTabColors.logistics } as React.CSSProperties}
                          className="px-3 py-2 text-xs sm:text-sm font-medium text-black border-b-2 border-transparent data-[state=active]:text-[var(--tab-color)] data-[state=active]:border-[var(--tab-color)] whitespace-nowrap"
                        >
                      ...
                      <TabsContent value="overview">
                        <h3 className="text-2xl font-semibold mt-6">PAML Train-the-Trainer — Jan–Apr 2025</h3>
                      ...
                      <TabsContent value="what">
                        <h3 className="text-2xl font-semibold mt-6">What You Will Do</h3>
                      ...
                      <TabsContent value="sessions">
                        <h3 className="text-2xl font-semibold mt-6">PAML Session Plans (Highlights)</h3>
                      ...
                      <TabsContent value="logistics">
                        <h3 className="text-2xl font-semibold mt-6">Engagement, Logistics & Instructor</h3>
                    ...
                    <div className="mt-6">
                      ...
                      <div className="mt-6 flex items-center gap-3 flex-wrap">
                        ...
                        <Link href="/students/courses"><Button variant="outline" className="border-black text-black">Back to Courses</Button></Link>
                      </div>
                    </div>
                  </div>
            ...
            {/* Summer Workshop 2025 Tab Content */}
            <TabsContent value="sw2025">
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6 }}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
                  {[
                    ...
                    <motion.div
                      ...
                      className="flex items-center gap-3 bg-gradient-to-r from-orange-50 to-orange-50 p-3 md:p-4 rounded-xl border border-orange-200"
                    >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                ...
                >
                  ...
                  <div className="space-y-3 md:space-y-4">
                    <div className="flex justify-between items-center py-2 md:py-3 border-b border-gray-100">
                      ...
                      <span className="text-base md:text-lg font-bold text-orange-600">8 weeks</span>
                    </div>
                    <div className="flex justify-between items-center py-2 md:py-3 border-b border-gray-100">
                ...
                <motion.div
                  ...
                  whileInView={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.6, delay: 0.1 }}
                  className="bg-white rounded-2xl p-6 md:p-8 shadow-lg text-gray-700 border border-orange-200"
                >
                  <h3 className="text-xl md:text-2xl font-bold mb-4 md:mb-6">Outcomes</h3>
                  <div className="space-y-4 md:space-y-6">
                    <div className="flex items-start gap-3 md:gap-4">
                      <span className="text-xl md:text-5xl font-bold text-orange-600">11</span>
                      <div>
                    ...
                    <div className="flex items-start gap-3 md:gap-4">
                      <svg className="w-8 h-8 md:w-10 md:h-10 text-orange-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="mt-8 flex justify-center">
                <Link href="/students/courses">
                  <Button variant="outline" className="border-black text-black">Back to Courses</Button>
                </Link>
              </div>
            </TabsContent>

            {/* Add more TabsContent here for Summer Workshop 2024, etc. */}
          </Tabs>
        </div>
      </section>
    </div>
