            ...
            <TabsContent value="ignite">
              <div className="space-y-8">
                ...
                <div className="rounded-2xl p-8" style={{ background: `linear-gradient(to right, ${studentsColors.primary}15, ${studentsColors.accent}15)` }}>
                  <h4 className="text-2xl font-bold mb-4 text-gray-900">From Spark to Flame: The Solution Revolution</h4>
                  ...
                  <div className="grid md:grid-cols-4 gap-6">
                    <div className="text-center">
                      <div className="mb-4 flex justify-center">
                        <Lightbulb className="w-12 h-12 text-gray-600" />
                      </div>
                      <h5 className="text-lg font-bold mb-2 text-gray-900">Idea-2-Market</h5>
                    ...
                    <div className="text-center">
                      ...
                      <h5 className="text-lg font-bold mb-2 text-gray-900">Team Collaboration</h5>
                    ...
                    <div className="text-center">
                      ...
                      <h5 className="text-lg font-bold mb-2 text-gray-900">Pitch Experience</h5>
                    ...
                    <div className="text-center">
                      ...
                      <h5 className="text-lg font-bold mb-2 text-gray-900">Attractive Awards</h5>
                ...
                <div>
                  <h4 className="text-2xl font-bold mb-6 text-center text-gray-900">Program Structure</h4>
                  <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6">
                    <div className="text-center">
                      <div className="w-40 h-40 rounded-full flex items-center justify-center border-4 mx-auto" style={{ borderColor: studentsColors.primary, backgroundColor: `${studentsColors.primary}10` }}>
                        <div>
                          <div className="text-2xl font-bold text-gray-900">S0</div>
                    ...
                    <div className="text-center">
                      <div className="w-40 h-40 rounded-full flex items-center justify-center border-4 mx-auto" style={{ borderColor: studentsColors.primary, backgroundColor: `${studentsColors.primary}10` }}>
                        <div>
                          <div className="text-2xl font-bold text-gray-900">S1</div>
                    ...
                    <div className="text-center">
                      <div className="w-40 h-40 rounded-full flex items-center justify-center border-4 mx-auto" style={{ borderColor: studentsColors.primary, backgroundColor: `${studentsColors.primary}10` }}>
                        <div>
                          <div className="text-2xl font-bold text-gray-900">S2</div>
                ...
                <div>
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="border rounded-lg p-6 bg-gray-50">
                      <h5 className="text-xl font-bold mb-3 text-gray-900">FastTrack</h5>
                    ...
                    <div className="border rounded-lg p-6 bg-gray-50">
                      <h5 className="text-xl font-bold mb-3 text-gray-900">Explorer Track</h5>
                    ...
                    <div className="border rounded-lg p-6 bg-gray-50">
                      <h5 className="text-xl font-bold mb-3 text-gray-900">Wildcard Track</h5>
                ...
                <div className="rounded-2xl p-8" style={{ background: `linear-gradient(to right, ${studentsColors.primary}15, ${studentsColors.accent}15)` }}>
                  <h4 className="text-2xl font-bold mb-4 text-gray-900">The Ignite Reward System</h4>
                  <div className="mt-4">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="flex gap-4">
                      <div className="font-bold text-lg text-gray-900">January:</div>
                      <div>
                    ...
                    <div className="flex gap-4">
                      <div className="font-bold text-lg text-gray-900">February:</div>
                      <div>
                    ...
                    <div className="flex gap-4">
                      <div className="font-bold text-lg text-gray-900">March:</div>
                      <div>
                    ...
                    <div className="flex gap-4">
                      <div className="font-bold text-lg text-gray-900">April:</div>
                      <div>
                ...
                <div className="rounded-2xl p-8 text-center" style={{ background: `linear-gradient(to right, ${studentsColors.primary}15, ${studentsColors.accent}15)` }}>
                  <h4 className="text-3xl font-bold mb-4">Ready to Build What Matters?</h4>
                  ...
                  <p className="text-xl font-bold mt-4 text-gray-700">The world has enough problems. It's time to build the solutions.</p>
                </div>
