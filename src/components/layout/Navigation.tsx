...
const STUDENT_SECTIONS: NavigationSection[] = [
  {
    title: 'Programs',
    items: [
      {
...
const INDUSTRY_SECTIONS: NavigationSection[] = [
  {
    title: 'Collaboration',
    items: [
      {
...
const ALUMNI_SECTIONS: NavigationSection[] = [
  {
    title: 'Community',
    items: [
      {
...
const INSIDE_CIE_SECTIONS: NavigationSection[] = [
  {
    title: 'About CIE',
    items: [
      {
...
const NavigationItem: React.FC<NavigationItemProps> = ({
  ...
  return (
    <NavigationMenuItem className="relative">
      ...
      <NavigationMenuContent>
        <div className="w-auto min-w-[900px] max-w-[1200px] bg-white backdrop-blur-sm rounded-l shadow-lg border border-gray-200">
          {/* Header */}
...
const StudentsNavigation: React.FC = () => {
  ...
  const sections = STUDENT_SECTIONS;
...
const IndustryNavigation: React.FC = () => {
  ...
  const sections = INDUSTRY_SECTIONS;
...
const AlumniNavigation: React.FC = () => {
  ...
  const sections = ALUMNI_SECTIONS;
...
const InsideCIENavigation: React.FC = () => {
  ...
  const sections = INSIDE_CIE_SECTIONS;
...
export const MobileNavigation: React.FC<MobileNavigationProps> = ({ isOpen, onClose }) => {
  ...
  const navigationItems = useMemo(() => [
    ...
    },
    {
      ...
      href: '/alumni',
      icon: GraduationCap,
      sections: ALUMNI_SECTIONS
    },
    {
      title: 'Inside CIE',
      href: '/inside-cie',
      icon: Microscope,
      sections: INSIDE_CIE_SECTIONS
    }
  ], []);
